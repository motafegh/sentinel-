...
| `macro_f1_vs_baseline` | macro_F1 >= baseline (0.1998) | PASS | macro_F1 = 0.3008 (delta +0.1009 vs baseline 0.1998) |
...
|---|---|---|---|
| macro_F1 | 0.1998 | 0.3008 | +0.1009 |
| macro_Fbeta | 0.2246 | 0.3821 | +0.1576 |
