...
| `macro_f1_vs_baseline` | macro_F1 >= baseline (0.2455) | PASS | macro_F1 = 0.2455 (delta +0.0000 vs baseline 0.2455) |
...
|---|---|---|---|
| macro_F1 | 0.2455 | 0.2455 | +0.0000 |
| micro_F1 | 0.2736 | 0.2736 | +0.0000 |
| contract_accuracy_loose | 0.4091 | 0.4091 | +0.0000 |
