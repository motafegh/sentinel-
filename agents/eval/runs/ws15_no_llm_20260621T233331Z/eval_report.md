...
**Macro-F1:** 0.2553  |  **Micro-F1:** 0.2839
...
| `macro_f1_vs_baseline` | macro_F1 >= baseline (0.2455) | PASS | macro_F1 = 0.2553 (delta +0.0098 vs baseline 0.2455) |
...
| CallToUnknown | 13 | 8 | 25 | 5 | 50 | 0.2424 | 0.6154 | 0.3478 |
...
- **Loose** (safe→no flag OR vuln→≥1 correct flag): 38/88 = 43.18%
...
| 01_unbounded_refund | vulnerable | DenialOfService | CallToUnknown,ExternalBug,Reentrancy | — | CallToUnknown,ExternalBug,Reentrancy | DenialOfService | ✗ |
...
| 03_delegatecall_injection | vulnerable | ExternalBug | CallToUnknown,ExternalBug,IntegerUO,Reentrancy,TransactionOrderDependence | ExternalBug | CallToUnknown,IntegerUO,Reentrancy,TransactionOrderDependence | — | ✓ |
...
| 04_opaque_contract_factory | vulnerable | CallToUnknown | CallToUnknown,ExternalBug,TransactionOrderDependence | CallToUnknown | ExternalBug,TransactionOrderDependence | — | ✓ |
...
| 06_tricky_unused_return_in_callchain | vulnerable | UnusedReturn,CallToUnknown | CallToUnknown,ExternalBug,IntegerUO,Reentrancy,Timestamp,UnusedReturn | CallToUnknown,UnusedReturn | ExternalBug,IntegerUO,Reentrancy,Timestamp | — | ✓ |
...
|---|---|---|---|
| macro_F1 | 0.2455 | 0.2553 | +0.0098 |
| micro_F1 | 0.2736 | 0.2839 | +0.0103 |
| contract_accuracy_loose | 0.4091 | 0.4318 | +0.0227 |
