...
| `deduplicator.py` | ~60 | SHA256 hash-based document deduplication |
| `feedback_loop.py` | 470 | `OnChainListener` + `FeedbackIngester` — AuditRegistry polling |
| `scheduler_cron.py` | ~30 | Cron-based scheduling |
| `scheduler_dagster.py` | ~80 | Dagster asset + daily schedule |
