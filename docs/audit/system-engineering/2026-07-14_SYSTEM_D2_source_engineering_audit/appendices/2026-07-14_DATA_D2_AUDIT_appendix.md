# SENTINEL D2 DATA source-engineering audit appendix

**Audit date:** 2026-07-14
**Runtime baseline:** `4b5bd333c`
**Mode:** audit only; recovered track evidence normalized to stable D2 IDs
**Track status:** `track-reproduced`; D2-DATA-001 and D2-DATA-002 are independently primary-reproduced
...
### D2-DATA-001 — Archive extraction escapes its destination
...
### D2-DATA-002 — Export integrity checks do not bind the released dataset
...
### D2-DATA-003 — Graph and token shards can silently describe different contracts
...
### D2-DATA-004 — The advertised full pipeline cannot complete and fails open
...
### D2-DATA-005 — Preprocessing can mutate valid Solidity into invalid or semantically different source
...
### D2-DATA-006 — Ingestion provenance is mutable and folderization invalidates manifests
...
### D2-DATA-007 — Parallel preprocessing disables deterministic deduplication
...
### D2-DATA-008 — Split leakage and class-balance controls are not enforced
...
### D2-DATA-009 — Verification can pass with no usable evidence and is disconnected from export
...
### D2-DATA-010 — Representation versioning does not uniquely determine tensors
...
### D2-DATA-011 — Registry is neither immutable nor connected to the final export
...
### D2-DATA-012 — Fresh-clone and package reproducibility are absent
...
### D2-DATA-013 — Benchmark material is not valid release evidence
...
### D2-DATA-014 — Responsibility and performance debt obscure failures
