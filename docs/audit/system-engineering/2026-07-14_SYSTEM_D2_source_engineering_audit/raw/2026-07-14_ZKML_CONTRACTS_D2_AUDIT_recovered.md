...
### ZKC-001 — P0 defect/protocol exploit: proof replay and audit identity are unbound
...
### ZKC-002 — P1 cryptographic/trust risk: proof semantics are narrower than the stored claim
...
### ZKC-003 — P1 correctness/availability defect: fixed transaction gas fails and reverted receipts are reported as submitted
...
### ZKC-004 — P1 concurrency/operational risk: proof artifacts and transaction nonces are shared
...
### ZKC-005 — P1 scientific/correctness defect: proxy outputs have contradictory probability/logit semantics
...
### ZKC-006 — P1 scientific risk: distillation promotion is not fail-closed or reproducible
...
### ZKC-007 — P1 provenance/artifact defect: fixed parameters invalidate the “keys survive retraining” assumption
...
### ZKC-008 — P1 provenance/integration defect: model and proof hashes diverge across boundaries
...
### ZKC-009 — P1 compatibility defect: one verifier cannot service both V1 and V2 write paths
...
### ZKC-010 — P1 protocol gap: stake does not secure an audit round
...
### ZKC-011 — P1 architecture gap: no quorum, round, or finality exists
...
### ZKC-012 — P1 governance/upgrade risk: immediate deployer control
...
### ZKC-013 — P1 fresh-clone/CI/artifact availability gap
...
### ZKC-014 — P1 secret-management defect
...
### ZKC-015 — P1 verifier/deployment lifecycle gap
...
### ZKC-016 — P2 testability debt: mocks hide the trust-boundary failures
...
### ZKC-017 — P2 gas/storage scalability debt
...
### ZKC-018 — P2 dependency/configuration debt
