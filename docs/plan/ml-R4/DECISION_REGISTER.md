...
| R4-D-011 | 2026-09-02 | ACCEPTED | V10 V2.6 physical representation / Phase-8 launch boundary | Accept the exact protected-local 22,540-contract graph-schema-V10 root under extractor `v2.6-r4-call-semantics-deterministic-cfg-mutators` and binding digest `d9f925588913e66476cfbc097bace7daa7e673295fe2a243760313d0bef5ebdd` as immutable physical representation evidence. Keep G8 open and training unauthorized. | ADR-R4-011; `runs/2026-09-02_PHASE8_v10_v26_physical_acceptance_and_no_launch.md`; machine record `evidence/2026-09-02_v10_v26_physical_acceptance/acceptance.json`; refreshed V4 audit SHA-256 `1e037c5d...` | Use the accepted V2.6 root only as the physical parent for controlled research or a later separately authorized training lineage; selector/objective/labels remain unchanged | select an earlier immutable hash-bound lineage for reproduction; never mutate the accepted V2.6 root or restore v9 new-run eligibility | delegated technical owner / Codex local primary |
...
R4-D-011 now supplies the separate physical-acceptance authority after explicit review of the passed, bound V2.6 V4 transition report. The exact V2.6 root and digest are immutable accepted physical evidence. G8 remains open and training authority remains separate.
