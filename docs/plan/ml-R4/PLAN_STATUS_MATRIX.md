...
| 7 | `phases/08_PHASE_7_DATA_VNEXT_IMPLEMENTATION.md` | READY | G6 | G7 | Implement accepted data-vnext-policy-v1 with frozen r4-vnext-roles-v1; no role rebalancing or semantic invention |
