...
| 5 | `phases/06_PHASE_5_DATA_VNEXT_POLICY_AND_DESIGN.md` | READY | G4 | G5 | Convert Phase-0–4 evidence and role recommendations into versioned DATA vNext policy/ADRs; no new semantic decisions in implementation |
