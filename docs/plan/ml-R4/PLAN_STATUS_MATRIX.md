...
| 8 | `phases/09_PHASE_8_EXISTING_MODEL_RETRAINING.md` | IN_PROGRESS | G7 | G8 | R4-D-008 accepts physical `sentinel-r4-vnext-v2` for bounded research after 22,540 contracts / 67,620 files passed binding and the bounded repaired-data GPU smoke passed. G8 remains open: all 899 effective loss cells are positive-only, no confirmed negatives exist, and the measured four-window control has material target-code omission. Full 100-epoch training is not authorized. |
...
| Full training / G8 | HOLD | All 899 effective loss cells target positive class `1`; confirmed negatives, threshold/calibration, and untouched acceptance remain absent. Current token selection also omits material target code. |
...
The completed rebuild procedure is preserved in the local-data handoff and gate re-audit. Current authority is the combination of R4-D-008 / `adrs/ADR-R4-008-repaired-v2-data-acceptance-and-phase8-no-launch.md` and `runs/2026-08-15_PHASE8_repaired_data_acceptance_and_launch_decision.md`. No old pretraining handoff may be used to launch the 100-epoch job.
