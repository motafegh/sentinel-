...
| 5 | `phases/06_PHASE_5_DATA_VNEXT_POLICY_AND_DESIGN.md` | IN_PROGRESS | G4 | G5 | Versioned DATA vNext policy and ADR design in progress; no implementation authorized |
