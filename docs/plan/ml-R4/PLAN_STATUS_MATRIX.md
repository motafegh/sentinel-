...
| 7 | `phases/08_PHASE_7_DATA_VNEXT_IMPLEMENTATION.md` | IN_PROGRESS | G6 | G7 | Building additive v2 semantic overlay + validators + explicit loader; final physical representation binding is local-only |
