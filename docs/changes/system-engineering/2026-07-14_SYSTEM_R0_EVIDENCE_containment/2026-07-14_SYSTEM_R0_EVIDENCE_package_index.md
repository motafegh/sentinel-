...
R0.1 is accepted (R0-EVIDENCE-OUTAGE). The remaining seven rows remain open. R0.2–R0.6 must produce clean candidate identities, comparable after records with `kind: r0_evidence_record`, regression measurements, and explicit accepted review before their rows close.
