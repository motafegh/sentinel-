...
| 2026-05-04 | [2026-05-04-post-training-audit-fixes.md](2026-05-04-post-training-audit-fixes.md) | Fix #1–#7 (dataset edge_attr, predictor arch args, warmup edge_attr, API thresholds key, arch dim fallback); Fix #9 MLflow focal params |
