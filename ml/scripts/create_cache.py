...
─────
    ...
    Optional flags:
      ...
      --output       ml/data/cached_dataset.pkl  (default)
      --workers      8   parallel loaders        (default: 8)

Output
──────
ml/data/cached_dataset.pkl   dict  md5_stem → (graph, tokens)
...
def main() -> None:
    ...
    p.add_argument("--output",     default="ml/data/cached_dataset.pkl")
