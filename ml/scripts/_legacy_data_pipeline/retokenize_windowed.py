#!/usr/bin/env python
"""
Windowed GraphCodeBERT Tokenizer — Multi-Window Production Pipeline
===================================================================
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Windowed GraphCodeBERT Tokenizer — Multi-Window Production Pipeline",
...
Examples:
  ...
  python ml/scripts/retokenize_windowed.py --test      # 100 contracts only
    ...
    print("=" * 70)
    print("Windowed GraphCodeBERT Tokenizer")
    print("=" * 70)
